/* cppbuch/loesungen/k3/7/taschenrechner.cpp
...
const std::string& Taschenrechner::getAnfrage() const { return anfrage; }

long Taschenrechner::getErgebnis() const { return ergebnis; }
